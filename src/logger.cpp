...
#define YELLOW_COLOR_STRING(s) ("\033[33;1m" + s + "\033[0m")
#define MAGENTA_COLOR_STRING(s) ("\033[35;1m" + s + "\033[0m")
#define CYAN_COLOR_STRING(s) ("\033[36;1m" + s + "\033[0m")
...
namespace logis {
	...
	std::map<LogFlags, LogColor> Logger::m_logColors{
		...
		{ LogFlags::Debug, LogColor::Yellow },
	...
	void Logger::write(const std::string& message, LogColor color) {
		...
		case LogColor::Yellow:
			std::cerr << YELLOW_COLOR_STRING(message);
			break;
		case LogColor::Magenta:
			std::cerr << MAGENTA_COLOR_STRING(message);
			break;
		case LogColor::Cyan:
			std::cerr << CYAN_COLOR_STRING(message);
			break;
		default:
			std::cerr << message;
		}
